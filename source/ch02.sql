...
INSERT INTO burgers
VALUES (2, '빅', 1000, 223, 444, 111);
-- 데이터를 넣지 않으면 null이 들어감
INSERT INTO burgers (id, name, price, gram)
VALUES (3, '빅', 1000, 223);
...
-- 특정(단일) 레코드 수정하기
-- 수정 대상 조건: 키를 통한 변경 쿼리
UPDATE burgers
SET price = 500 WHERE id = 1;

SELECT * FROM burgers ORDER BY kcal DESC;
